/**
 * Represent HolbertonCourse javascript class
 */
export default class HolbertonCourse {
  /**
   * Create a new course
   *
   * @param {type: <String>} name - Name of the course
   * @param {type: <Number>} length - Duration of the course (year)
   * @param {type: <String[]>} students - List of students offering the course
   */
